...
class main_init(object):
   def __init__(self):
       latitud = float(input("¿Favor de escribir latitud?"))
       longitud = float(input("¿Favor de escribir longiutd?"))
...
class location(object):
   ...
   def __init__(self, lugar):
       ...
       geolocalizacion(self.lista_location)

class geolocalizacion(object):
   lista_lat = []
   lista_lon = []
